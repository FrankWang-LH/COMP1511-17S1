...
int main(int argc, char *argv[]) {
    ...
    if (read_pbm(argv[1], height, width, pixels)) {
        ...
        three = threes(box_height,box_width,box_pixelsA);
        ...
        three = threes(box_height,box_width,box_pixelsB);
        ...
        three = threes(box_height,box_width,box_pixelsC);
        ...
        three = threes(box_height,box_width,box_pixelsD);
